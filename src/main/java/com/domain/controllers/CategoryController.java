...
public class CategoryController {
    ...
    @PutMapping
    public ResponseEntity<ResponseData<Category>> update(@Valid @RequestBody CategoryData updateCategoryData, Errors errors){
        ResponseData<Category> responseData = new ResponseData<>();
        ...
        Category category = modelMapper.map(updateCategoryData, Category.class);
